...
**Round:** 第二个 85 · 第一轮 / Phase-II Central Assault  
...
85_phaseII_R1_counterexample_certificate.py
85_phaseII_R1_counterexample_certificate.txt
```

The certificate verifies the displayed live deep countermodel by exact integer arithmetic.

FINAL_REPORT_FILE: 85_phaseII_R1_moving_square_exactization.md
