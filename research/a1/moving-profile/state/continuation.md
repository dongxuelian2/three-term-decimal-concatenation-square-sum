...
[the open-state record](open-state.md).

## 1. State reconstruction

The complete recovery is in
[the state-reconstruction record](state-reconstruction.md). The
recovered state is:
...
The full record is referenced in the
[migration unresolved-items record](../../../../provenance/UNRESOLVED_MIGRATION.md#historical-state-references-not-present-as-separate-files),
because the named local snapshot was not available as a separate source file.
...
Artifact: [the unresolved historical stage reference](../../../../provenance/UNRESOLVED_MIGRATION.md#historical-state-references-not-present-as-separate-files)
...
Artifact: [the quotient-and-support audit](quotient-and-support-audit.md)
...
- [the unresolved historical stage obligation](../../../../provenance/UNRESOLVED_MIGRATION.md#historical-state-references-not-present-as-separate-files)
- [the source-room successor audit](source-room-successor-audit.md)
...
Artifact: [the bounded-search audit](bounded-search-audit.md)

The rerunnable scripts are:

- `105_V3_R40_quotient_audit.py` and `105_V3_R40_small_root_search.py` are
  documented as unavailable historical snapshots in the
  [migration unresolved-items record](../../../../provenance/UNRESOLVED_MIGRATION.md#historical-state-references-not-present-as-separate-files).
...
The byte-level source accounting is the
[migration map](../../../../provenance/MIGRATION_MAP.tsv); the named local
`105_V3_SHA256_MANIFEST.txt` snapshot is documented as unavailable in the
[migration unresolved-items record](../../../../provenance/UNRESOLVED_MIGRATION.md#historical-state-references-not-present-as-separate-files).
